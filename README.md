Primero, ordenar la carpeta donde se van a ejecutar los códigos, debido a que la carpeta "SROMPy" (descomprimida del zip) debe estar en la misma carpeta donde estarán los códigos que llaman la biblioteca.
Por otro lado, también la carpeta "Database" (que contiene los escenarios de ruptura y base de datos de PTHA) debe estar en el mismo lugar donde se ejecutarán los códigos. Esta puede ser nueva (nuevas rupturas generadas) o la utilizada por mí.
